...
// guided roadmap, not a topic library (PC-002).
  ...
  return (
    <section className="flex flex-col gap-5">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-2xl font-semibold text-white">Willkommen</h1>
        <p className="text-sm leading-relaxed text-deck-muted">
          Dein geführter Weg zu AI Engineering und AI-native System Architecture.
          Folge der Roadmap Schritt für Schritt — jede Node baut auf der vorherigen
          auf.
        </p>
      </div>
      ...
      {ready && (
        <Card className="flex flex-col gap-3">
          ...
          <span className="text-sm font-medium text-white">
            {currentNode
              ? `Als Nächstes: ${currentNode.title}`
              : 'Alle Nodes abgeschlossen 🎉'}
          </span>
          <Link
            to={paths.roadmap}
          ...
          >
            {completedCount > 0 ? 'Weiterlernen' : 'Roadmap starten'}
          </Link>
        </Card>
      )}
    </section>
